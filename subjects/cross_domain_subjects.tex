...
\begin{itemize}
	...
	\item When filling an outgoing message table (e.g. protocol messages), remember DHCP is in broadcast, ARP is needed to resolve MAC addresses (and is in Layer 2), and notice what LAN is followed.
