...
% Title formatting
\titleformat{\section}{\fontsize{6pt}{6pt}\selectfont\bfseries}{\thesection}{0em}{\colorbox{yellow!70}}
\titleformat{\subsection}{\fontsize{5pt}{5pt}\selectfont\bfseries}{\thesubsection}{0em}{\colorbox{green!20}}
\titleformat{\subsubsection}{\fontsize{5pt}{5pt}\selectfont\bfseries}{\thesubsubsection}{0em}{\colorbox{blue!10}}
...
\begin{multicols*}{4}
    ...
    % Content sections
    \input{subjects/interdomain_routing_&_bgp}
    \input{subjects/math}
    \input{subjects/math}
    \input{subjects/math}
    \input{subjects/math}
